...
INSERT INTO `c237_026_team5_ca2`.`user` (`user_id`, `card_id`, `name`, `phone_number`, `password`, `role`, `points`, `primary_user_id`) VALUES
...
-- Categories
-- -----------------------------------------------------
INSERT INTO `c237_026_team5_ca2`.`category` (`category_id`, `name`) VALUES
(1, 'Asian'),
(2, 'Tandoori'),
(3, 'Pasta'),
(4, 'Pizza'),
...
-- -----------------------------------------------------
INSERT INTO `c237_026_team5_ca2`.`menu_item_has_size` (`menu_item_id`, `size_id`, `price`) VALUES
...
-- -----------------------------------------------------
INSERT INTO `c237_026_team5_ca2`.`menu_item_has_add_on` (`menu_item_id`, `add_on_id`) VALUES
...
-- Total = 79
-- -----------------------------------------------------
INSERT INTO `c237_026_team5_ca2`.`order` (`order_id`, `user_id`, `total`, `points_earned`, `points_redeemed`, `discount_amount`) VALUES
...
INSERT INTO `c237_026_team5_ca2`.`order_item_has_add_on` (`order_item_id`, `add_on_id`) VALUES
